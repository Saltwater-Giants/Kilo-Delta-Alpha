...
export default class DraftPicks extends React.Component {
  ...
  async componentDidMount() {
    ...
    let intervalId = setInterval(() => {getCardPositions().then((response) => {
    ...
    this.setState({intervalId: intervalId, currentPicks: draftPicksFromRectangles(rectangles), currentTrades: draftTradesFromRectangles(rectangles)});
  }

  render() {
    return (
      <div className="draft-picks">
        { this.props.State === 'Swapping' ?
          <div>
